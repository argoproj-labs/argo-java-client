 ...
 * 1) Set a break point in ArgoprojJavaClientOpenapiCodeGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class ArgoprojJavaClientOpenapiCodeGeneratorTest {
...
//              .setGeneratorName("argoproj-java-client-openapi-code") // use this codegen library
...
//              .setOutputDir("out/argoproj-java-client-openapi-code"); // output directory
//
